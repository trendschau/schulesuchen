...
$lng        = 7.0116;
$zoom       = 11;
$outFile    = __DIR__ . "/../essen/data/schulen.geojson";
...
$schools    = readCsv(__DIR__ . "/../data-nrw/schuldaten.csv");
$traeger    = indexBy(readCsv(__DIR__ . "/../data-nrw/key_traeger.csv"),"Traegernummer");
$schulform  = indexBy(readCsv(__DIR__ . "/../data-nrw/key_schulformschluessel.csv"),"Schluessel");
$anzahl     = indexBy(readCsv(__DIR__ . "/../data-nrw/anzahlen.csv"),"Schulnummer");
